...
def compute_mid_result(task_name, task_submit_date):
    ...
    # test
    temp_0 = [('2013-09-01', {'核电站污水泄漏':2, '日本地震': 3, '黄岩岛': 5}), ('2013-09-02',{'黄岩岛':3, '李开复患癌':6}), ('2013-09-03', {'李开复患癌':4, '黄岩岛':2, '核电站污水泄漏':1}), ('2013-09-04', {'斯诺登在俄罗斯': 7, '黄岩岛':4}), ('2013-09-05', {'正能量': 8, '斯诺登在俄罗斯':4}), ('2013-09-05', {"打击非法营运":3, '道路交通指数播报':1, '斯诺登在俄罗斯':2}), ('2013-09-06', {'打击非法营运':3, '叙利亚危机': 5, '今日头条': 2}), ('2013-09-07', {'美国对叙动武':9, '图样图森破':2, '民航':1})]
    temp_1 = [('2013-09-01', {'习近平出访':4, '党':3}), ('2013-09-02', {'习近平出访':3, '中国梦':4, '党':1}), ('2013-09-03', {'习近平出访':4, '中国梦':4, '京报快评':3}), ('2013-09-04', {'习近平出访': 3, '美国对叙动武':4}), ('2013-09-05', {'全运争议': 6}),('2013-09-06', {'全运争议':3, '缅怀伟人毛泽东':4}), ('2013-09-07', {'京籍家长抗议异地高考':2})]
    result['hashtag_0'] = temp_0
    result['hashtag_1'] = temp_1
    return result
