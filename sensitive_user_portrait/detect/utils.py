...
from sensitive_user_portrait.global_utils import R_GROUP as r_group
from sensitive_user_portrait.global_utils import group_detect_queue_name, group_analysis_queue_name
...
from sensitive_user_portrait.parameter import DETECT_ITER_COUNT, MAX_VALUE, MAX_PROCESS
