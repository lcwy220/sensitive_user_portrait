...
from global_utils import comment_index_name_pre, be_comment_index_name_pre
...
def comment_es_mappings(db_number):
    ...
    index_name = comment_index_name_pre + db_number
...
def be_comment_es_mappings(db_number):
    ...
    index_name = be_comment_index_name_pre + db_number
    exist_indice = es.indices.exists(index=index_name)
    if exist_indice:
        es.indices.delete(index=index_name)
