...
function get_input_data(){
 ...
 $(".addIcon").off("click").click(function(){
        ...
        html = '<div class="add_word_model" style="margin-top:12px;">等级:<select name="level" class="add_sensi_level" style="width:90px; margin-right:5px;">  <option value="1">level 1</option>   <option value="2">level 2</option><option value="3">level 3</option></select>类别:<select name="classify" class="add_sensi_class" style="width:90px; margin-right:5px;">  <option value="politics">politics</option><option value="military">military</option><option value="law">law</option><option value="ideology">ideology</option><option value="democracy">democracy</option></select><br><input class="input_sensi" style="min-width: 50px;margin-top:20px;" placeholder="输入敏感词"><span class="addIcon" id="addTag" style="margin-bottom:-10px;margin-top:20px;"></span></div>';
        $('#test').append(html);
    });
