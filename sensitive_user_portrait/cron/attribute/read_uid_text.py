...
uid_text = file('sensitive_uid_text.csv', 'wb')
            ...
            for line in f:
                ...
                if weibo_item:
                    ...
                    if weibo_item_bin['message_type'] == 1:
                        ...
                        continue
                    item = [str(weibo_item_bin['uid']), write_text, str(weibo_item_bin['mid']), str(weibo_item_bin['send_ip']), str(weibo_item_bin['timestamp']) ]
