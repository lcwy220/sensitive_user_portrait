...
reload(sys)
sys.path.append('../../')
from global_utils import es_sensitive_user_portrait
from global_utils import es_user_profile
from global_utils import R_RECOMMENTATION as r
from global_utils import ES_CLUSTER_FLOW1 as es_bci
from global_utils import portrait_index_name, portrait_index_type, redis_cluster
...
def filter_in(top_user_set):
    results = []
    try:
        in_results = es_sensitive_user_portrait.mget(index=portrait_index_name, doc_type=portrait_index_type, body={'ids':list(top_user_set)})
