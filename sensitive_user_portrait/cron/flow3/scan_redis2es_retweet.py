...
from global_utils import retweet_index_name_pre, be_retweet_index_name_pre
...
def scan_retweet():
    ...
    while True:
        ...
        if retweet_bulk_action:
            es.bulk(retweet_bulk_action, index=retweet_index_name_pre+str(db_number), doc_type='user')
        if be_retweet_bulk_action:
            es.bulk(be_retweet_bulk_action, index=be_retweet_index_name_pre+str(db_number), doc_type='user')
        retweet_bulk_action = []
        be_retweet_bulk_action = []
        end_ts = time.time()
        #run_type
