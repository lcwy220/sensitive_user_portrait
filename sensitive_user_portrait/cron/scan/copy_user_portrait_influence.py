...
def main():
    ...
    while 1:
        try:
            ...
            add_info[uid] = {update_bci_key: normal_influence, "last_value":normal_influence,"user_fansnum":int(scan_re["fansnum"]) ,"politics":scan_re['politics'], "domain": scan_re['domain'], "activity_geo": scan_re["activity_geo"], "hashtag": scan_re['hashtag_string'],"sensitive_words_string":scan_re['sensitive_words_string'], "topic_string": scan_re["topic_string"]}
