...
import json
import csv
from global_utils_do import load_scws,cx_dict,single_word_whitelist,black_word,abs_path
...
if __name__ == '__main__':
    ...
    domain = domain_classfiy(uid_list,uid_weibo)
    with open('./weibo_data/result.csv', 'wb') as f:
        writer = csv.writer(f)
