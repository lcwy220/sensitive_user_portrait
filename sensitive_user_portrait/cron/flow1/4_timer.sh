#!/bin/sh
cd /home/ubuntu01/user_portrait/user_portrait/cron/flow1
...
tmux send-keys -t work:es1 'python redis_to_es.py >> /home/log/flow1.log' C-m
tmux send-keys -t work:es2 'python redis_to_es.py >> /home/log/flow1.log' C-m
tmux send-keys -t work:es3 'python redis_to_es.py >> /home/log/flow1.log' C-m
tmux send-keys -t work:es4 'python redis_to_es.py >> /home/log/flow1.log' C-m
