    ...
    require([
        ...
        function(ec){
            ...
            function focus(param) {
                ...
                var ajax_url = '/group/group_sentiment_weibo/?task_name='+name+'&sentiment='+sentiment+'&start_ts='+start_ts + '&submit_user=' + submit_user;
                $.ajax({
                      url: ajax_url,
                      type: 'GET',
                      dataType: 'json',
...
function Draw_group_trend(data){
    ...
    if(items==null){
        ...
        var html0 = '';
        var url_content = '/group/group_sentiment_weibo/?task_name='+name+'&sentiment=0&start_ts='+times_init + '&submit_user=' + submit_user;
...
function psy_load(){
    if(!global_psy_flag){
        var psy_url='/group/show_group_result/?task_name='+name+'&module=think' + '&submit_user=' + submit_user;
