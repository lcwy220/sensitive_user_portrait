...
function getAttributeName(){
    var attribute_name_url = '/tag/show_attribute_name/?user='+$('#current_user').text();
        ...
        */
        $('[name=tag_type]').change(function(){
            if ($(this).val() == ''){
                ...
                var attribute_value_url = '/tag/show_attribute_value/?user='+$('#current_user').text()+'&attribute_name=';
