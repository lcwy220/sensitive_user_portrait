...
def search_tag(es, number, active_index, active_type, portrait_index, portrait_type, field_dict, sort_order):
    ...
    while 1:
        search_list = []
        user_list = search_k(es, active_index, active_type, start, sort_order, 1000)
        start += 1000
...
if __name__ == "__main__":
    print search_tag(es, 10, "20130901", "bci", "user_portrait", "user", {"topic":"education"}, sort_order="user_index") 
