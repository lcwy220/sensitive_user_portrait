...
from sensitive_user_portrait.global_utils import es_sensitive_user_portrait as es_user_portrait
from sensitive_user_portrait.time_utils import datetime2ts, ts2datetime, ts2date
from sensitive_user_portrait.parameter import INFLUENCE_RETWEETED_THRESHOLD as retweeted_threshold
from sensitive_user_portrait.parameter import INFLUENCE_COMMENT_THRESHOLD as comment_threshold
from sensitive_user_portrait.parameter import INFLUENCE_TAG as influence_tag
from sensitive_user_portrait.parameter import pre_influence_index as pre_index
from sensitive_user_portrait.parameter import influence_doctype, DAY, RUN_TYPE
from sensitive_user_portrait.parameter import BCI_LIST, INFLUENCE_TOTAL_THRESHOULD, INFLUENCE_TOTAL_LIST, INFLUENCE_BRUST_THRESHOULD, INFLUENCE_BRUST_LIST
from sensitive_user_portrait.parameter import CURRNET_INFLUENCE_THRESHOULD, CURRENT_INFLUENCE_CONCLUSION, INFLUENCE_TOTAL_CONCLUSION, INFLUENCE_BRUST_CONCLUSION, UNDERLINE_CONCLUSION
from sensitive_user_portrait.global_utils import portrait_index_name as user_portrait
from sensitive_user_portrait.global_utils import es_flow_text as es
from sensitive_user_portrait.global_utils import flow_text_index_name_pre as pre_text_index
from sensitive_user_portrait.global_utils import portrait_index_type, flow_text_index_type, profile_index_type, profile_index_name
...
def influenced_detail(uid, date, weibo_style, order):
    date1 = str(date).replace('-', '')
    index_name = pre_index + date1
