...
from sensitive_user_portrait.global_utils import R_SOCIAL_SENSING as r
from sensitive_user_portrait.time_utils import ts2datetime, datetime2ts
from sensitive_user_portrait.global_utils import flow_text_index_name_pre, flow_text_index_type, profile_index_name, profile_index_type, \
                         portrait_index_name, portrait_index_type
from sensitive_user_portrait.parameter import SOCIAL_SENSOR_TIME_INTERVAL as time_interval
from sensitive_user_portrait.parameter import SOCIAL_SENSOR_FORWARD_RANGE as time_segment
from sensitive_user_portrait.parameter import DETAIL_SOCIAL_SENSING as index_sensing_task
from sensitive_user_portrait.parameter import INDEX_MANAGE_SOCIAL_SENSING as index_manage_social_task
from sensitive_user_portrait.parameter import DOC_TYPE_MANAGE_SOCIAL_SENSING as task_doc_type
from sensitive_user_portrait.parameter import FORWARD_N as forward_n
from sensitive_user_portrait.parameter import topic_value_dict
from sensitive_user_portrait.parameter import INITIAL_EXIST_COUNT as initial_count
from sensitive_user_portrait.parameter import IMPORTANT_USER_NUMBER, IMPORTANT_USER_THRESHOULD, signal_brust, signal_track, signal_count_varition, signal_sentiment_varition,signal_nothing, signal_nothing_variation, \
                      unfinish_signal, finish_signal, AGGRAGATION_KEYWORDS_NUMBER, PRE_AGGREGATION_NUMBER, DAY
from sensitive_user_portrait.time_utils import ts2date, datetime2ts, ts2datetime
day_time = 24*3600
