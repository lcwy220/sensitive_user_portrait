...
from sensitive_user_portrait.parameter import INDEX_MANAGE_SOCIAL_SENSING as index_manage_sensing_task
...
from sensitive_user_portrait.parameter import finish_signal, unfinish_signal, SOCIAL_SENSOR_INFO
...
def ajax_get_admin_sensi_words():
    words = R_ADMIN.hkeys("sensitive_words")
